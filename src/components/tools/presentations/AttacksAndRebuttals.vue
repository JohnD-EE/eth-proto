      ...
      tabItems: [
        {
          ...
          imageTitle: 'Regulation should protect ordinary people from fraud',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
        ...
        {
          tabTitle: 'Scalability and TPS',
          image: 'transaction.jpg',
          imageTitle: 'Merchants and customers expect Visa level transaction capabilities',
          content: [
            {
              subHeading: 'Attack',
              bullets: [
          ...
          ]},
        {
          tabTitle: 'Privacy',
          image: 'privacy.jpg',
          imageTitle: 'Who owns and controls your data?',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
        ...
        {
          tabTitle: 'Incumbent Resistance',
          image: 'banksUK.jpg',
          imageTitle: 'Government, banks and payments services derive their powerbase from the current system',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
          ...
          ]},
        {
          tabTitle: 'Crime',
          image: 'wannaCry.png',
          imageTitle: 'The WannaCry hackers used Ransomeware demanding payment in Cryptocurrency',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
          ...
          ]},
        {
          ...
          imageTitle: 'Moving fiat currency into cryptocurrency is not straightforward',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
        ...
        {
          tabTitle: 'Poor UX',
          image: 'mosaicBrowser.jpg',
          imageTitle: 'The Mosaic Browser, launched in 1993, making the Internet accessible to all',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
        ...
        {
          tabTitle: 'Security and Hacks',
          image: 'hacker.jpg',
          imageTitle: 'Mr Robot\'s Hacker, Elliot Alderson',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
        ...
        {
          tabTitle: 'Price Volatility',
          image: 'priceVolatility.png',
          imageTitle: 'Cryptocurrency Candlestick Chart',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
        ...
        },
        {
          tabTitle: 'Scam / Ponzi',
          image: 'ponzi.jpg',
          imageTitle: 'Charles Ponzi, the Itallian con man, originator of the eponymously named fraud',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
        ...
        },
        {
          tabTitle: 'Utopianism',
          image: 'utopia.jpg',
          imageTitle: 'The \'Yellow Brick Road\' to the utopia of Oz',
          content: [
            {
              subHeading: 'Attacks',
              bullets: [
