...
contract EIP20Factory {
    ...
    bool _isPointsOnly, address _issuer, bool _isTransferable)
        public
    returns (address) {

        EIP20 newToken = (new EIP20(_initialAmount, _name, _decimals, _symbol, _exchangeRateToEth, _isPointsOnly, _issuer, _isTransferable));
